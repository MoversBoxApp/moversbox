                                                        ...
                                                        <form id="vertical-form-wizard" align="left" action="#">
                                                            <div class="no">
                                                                ...
                                                                <section>
                                                                    ...
                                                                    <div class="row">
                                                                      <div style="border-right: 0.5px solid #768eea;" class="col col-div">
                                                                        Inventory
                                                                        <div class="table-responsive">
                                                                            <table id="inventoryItemsTable" class="table foo-filtering-table table-striped">
                                                                                <thead>
                                                                                    <tr>
                                                                                        <th class="t-items" style="min-width:auto">Item</th>
                                                                                        <th class="t-items">CuFt</th>
                                                                                        <th class="t-items">Qty</th>
                                                                                        <th class="t-items">Delete</th>
                                                                                    </tr>
                                                                                </thead>
                                                                                <tbody>
                                                                                </tbody>
                                                                      ...
                                                                      <div class="col col-div">
                                                                        Select a Room
                                                                        <div class="btn-group control-rooms p-t-5">
                                                                          <button type="button" onclick="setLivingRoom()" class="living btn btn-room btn btn-secondary-rgba" name="button">Living Room</button>
                                                                          <button type="button" onclick="setDiningRoom()" class="dining btn btn-room btn btn-success-rgba" name="button">Dining Room</button>
                                                                          <button type="button" onclick="setBedRoom()" class="bedroom btn btn-room btn btn-danger-rgba" name="button">Bedroom</button>
                                                                          <button type="button" onclick="setKitchen()" class="kitchen btn btn-room btn btn-secondary-rgba" name="button">Kitchen</button>
                                                                          <button type="button" class="nursery btn btn-room btn btn-primary-rgba" name="button">Nursery</button>
                                                                        </div>
                                                                        <div class="btn-group control-rooms p-t-5 p-b-5">
                                                                          <button type="button" onclick="" class="living btn btn-room btn btn-info-rgba" name="button">Office</button>
                                                                          <button type="button" class="dining btn btn-room btn btn-danger-rgba" name="button">Garage</button>
                                                                          <button type="button" class="bedroom btn btn-room btn btn-warning-rgba" name="button">Outdoor</button>
                                                                          <button type="button" class="kitchen btn btn-room btn btn-primary-rgba" name="button">Appliances</button>
                                                                          <button type="button" class="nursery btn btn-room btn btn-secondary-rgba" name="button">Boxes</button>
                                                                        </div>
                                                                          Select Items
                                                                          <div class="table-responsive">
                                                                              <table id="selItemsTable" style="overflow-y:scroll;" class="table foo-filtering-table table-striped">
                                                                                  <thead>
                                                                                      <tr>
                                                                                          <th class="t-items" style="min-width:auto">Item</th>
                                                                                          <th class="t-items">CuFt</th>
