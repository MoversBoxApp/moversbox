                    ...
                    <section>
                        ...
                        <div class="row">
                          <div class="col-md-6 col-div">
                            Select a Room
                            <div class="btn-list control-rooms">
                              <button type="button" onclick="setLivingRoom()" class=" btn btn-room btn btn-secondary-rgba" name="button">Living Room</button>
                              <button type="button" onclick="setDiningRoom()" class="btn btn-room btn btn-success-rgba" name="button">Dining Room</button>
                              <button type="button" onclick="setBedRoom()" class="btn btn-room btn btn-danger-rgba" name="button">Bedroom</button>
                              <button type="button" onclick="setKitchen()" class="btn btn-room btn btn-secondary-rgba" name="button">Kitchen</button>
                              <button type="button" class="btn btn-room btn btn-primary-rgba" name="button">Nursery</button>
                            <!-- </div>
                            <div class="btn-list control-rooms p-t-5 p-b-5"> -->
                              <button type="button" onclick="" class="btn btn-room btn btn-info-rgba" name="button">Office</button>
                              <button type="button" class="btn btn-room btn btn-danger-rgba" name="button">Garage</button>
                              <button type="button" class="btn btn-room btn btn-warning-rgba" name="button">Outdoor</button>
                              <button type="button" class="btn btn-room btn btn-primary-rgba" name="button">Appliances</button>
                              <button type="button" class="btn btn-room btn btn-secondary-rgba" name="button">Boxes</button>
                            </div>
                            <br>Select Items
                            <div class="table-responsive">
                              <table id="selItemsTable" class="table foo-filtering-table table-striped">
                                <thead>
                                  <tr>
                          ...
                          <div class="col-md-6 col-div">
                            Inventory
                            <div class="table-responsive">
                                <table style="border-left: 0.5px solid #8A98AC;" id="inventoryItemsTable" class="table foo-filtering-table">
                                    <thead>
                                        <tr>
                                            ...
                                            <th data-breakpoints="all" class="t-items" data-title="Dimensions">Dimensions (optional)</th>
