...
<html lang="en">
    <head>
        ...
        <meta name="description" content="The mover's app">
        <meta name="keywords" content="admin, admin dashboard, admin panel, movers, analytics, bootstrap 4, laravel, clean">
        ...
        <link id="style" href="{{ asset('assets/css/style.css') }}" rel="stylesheet" type="text/css">
        @yield('style')
        <!-- End CSS -->
    </head>
